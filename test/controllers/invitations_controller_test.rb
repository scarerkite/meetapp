...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { accepted: @invitation.accepted, event_id: @invitation.event_id, user: @invitation.user }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { accepted: @invitation.accepted, event_id: @invitation.event_id, user: @invitation.user }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
